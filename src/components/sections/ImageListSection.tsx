      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-16 py-20 grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-16 items-center">
        ...
        >
          ...
          {quote && (
            ...
            >
              <p className="font-serif font-light text-lg italic leading-relaxed text-secondary">&ldquo;{quote.text}&rdquo;</p>
        ...
        >
          ...
          {paragraphs.length > 0 && (
            <div className="font-sans text-lg leading-relaxed text-secondary/75 mb-6 space-y-4">
              {paragraphs.map((p, i) => (
                <p key={i}>{p}</p>
              ))}
            </div>
          ...
          >
            {items.map((item) => (
              <motion.li
                ...
                className="flex items-center gap-4 font-sans font-medium text-lg leading-relaxed text-secondary border-b border-secondary/8 py-6"
              >
