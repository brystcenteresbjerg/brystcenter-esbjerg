...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    a: "De første dage er præget af mild ømhed og hævelse. De fleste er tilbage på let kontorarbejde efter 1-7 dage. Det transplanterede væv etablerer egen blodforsyning over de første 3–4 måneder, og det endelige resultat vurderes ved kontrol efter ca. 6 måneder, når volumen har stabiliseret sig.",
  },
];
...
export const features: FeatureItem[] = [
  ...
  },
  {
    ...
    text: "Smerter og ømhed efter skader og kirurgi kan moduleres positivt med mindre eller fravær af smerter efterfølgende.",
  },
];

export const forloebetSummary = {
  duration: "40–55 min. · ambulant",
  note: "Lokal bedøvelse · kontrol aftales individuelt",
};

export const forloebetSection: SectionContent = {
  label: "Forløbet",
  heading: "Hvordan foregår en fedttransplantation?",
  body: "Processen kræver høj teknisk præcision for at sikre, at de transplanterede celler integreres optimalt i målvævet. Fedttransplantationen foregår i lokal eller fuld bedøvelse afhængig af formål og omfang af indgrebet. Da fedttransplantation er afhængig af biologiske forhold, vurderes det endelige resultat efter nogle måneder, når kroppen har optaget en del af det transplanterede væv og stabiliseret den nye volumen.",
};
...
export const forloebetSteps = [
  ...
  },
  {
    ...
    body: "Fedtet indsprøjtes i mange små depoter gennem 1–3 mm tynde kanyler – i flere lag og fra forskellige indstik for at opnå en jævn, tredimensionel fordeling. Den fine spredning sikrer, at hver enkelt fedtcelle hurtigt får adgang til ilt og blodforsyning, hvilket er forudsætningen for permanent integration. Vi overkorrigerer typisk en smule, da kroppen naturligt absorberer 20–40 % af det indsatte fedt.",
    bullets: ["Multi-layer micro-droplet teknik", "Næsten usynlige ar", "Bevidst overkorrektion 20–30 %"],
    duration: "10–20 min",
  },
];
